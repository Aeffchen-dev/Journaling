		...
		extend: {
			...
			colors: {
				...
				quiz: {
					...
					'category7-text': 'hsl(var(--quiz-category7-text))',
					'category8-bg': 'hsl(var(--quiz-category8-bg))',
					'category8-text': 'hsl(var(--quiz-category8-text))',
					'category9-bg': 'hsl(var(--quiz-category9-bg))',
					'category9-text': 'hsl(var(--quiz-category9-text))',
					'category10-bg': 'hsl(var(--quiz-category10-bg))',
					'category10-text': 'hsl(var(--quiz-category10-text))',
					'category11-bg': 'hsl(var(--quiz-category11-bg))',
					'category11-text': 'hsl(var(--quiz-category11-text))',
